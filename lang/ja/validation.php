...
return [
    ...
    'min'                  => [
        ...
        'string'  => ':パスワードの文字数は、:min文字以上である必要があります。',
    ],
    ...
    'password'             => [
        'letters'       => ':passwordは文字を1文字以上含める必要があります。',
        'mixed'         => ':passwordは大文字と小文字をそれぞれ1文字以上含める必要があります。',
        'numbers'       => ':passwordは数字を1文字以上含める必要があります。',
        'symbols'       => ':passwordは記号を1文字以上含める必要があります。',
        'uncompromised' => ':passwordは情報漏洩した可能性があります。他の:attributeを選択してください。',
    ],
